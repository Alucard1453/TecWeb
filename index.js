...
///////////////////////////////////////////////////////////////////////////////////
//Funcionamiento de la funcion de alta para nuevos articulos
...
function loadTemas(temas){
    ...
    //Aqui va la funcion para cargar el contenido de la pagina
    //getArticulosInteres();
    getMisTemas();
}
...
//Seccion para que funcione el select
//Carga los temas disponibles de acuerdo a la base de datos, devuelve un JSON
...
//Solicita un JSON a la base para obtener los articulos por temas o x interes
function getArticulos(id){
    localStorage.setItem("idTema",id);
    if(id==0){
      getArticulosInteres();
    }
    else{
      ...
      xmlhttp.open("GET", "JSON_articulosportema.php?idTema="+id, true);
      xmlhttp.send();
    }
}

//Funcion que obtendra el contenido ya sea de interes o los mas importantes
function getArticulosInteres(){
  var xmlhttp = new XMLHttpRequest();
  xmlhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
        //var articulosInteres = this.responseText;
        var articulosInteres = JSON.parse(this.responseText);
        console.log(articulosInteres);
        loadArticulos(articulosInteres);
    }
  };
  xmlhttp.open("GET", "JSON_temasInteres.php", true);
  xmlhttp.send();
}

//Se carga todo el DOM en base a la respuesta recibida
function loadArticulos(articulosMostrar){
  ...
  if(articulosMostrar){
      ...
      for(var i=0 ; i<elementos.length;i++){
          ...
          var buttonlike = document.createElement("button");
              ...
              buttonlike.setAttribute("id","botonlike"+elementos[i].idArticulo);
              buttonlike.setAttribute("onclick","like("+elementos[i].idArticulo+")");
          ...
          var buttondislike = document.createElement("button");
              ...
              buttondislike.setAttribute("id","botondislike"+elementos[i].idArticulo);
              buttondislike.setAttribute("onclick","dislike("+elementos[i].idArticulo+")");
          ...
          var buttonnotinterested = document.createElement("button");
              ...
              buttonnotinterested.setAttribute("id","botonnotinterested"+elementos[i].idArticulo);
              buttonnotinterested.setAttribute("onclick","notinterested("+elementos[i].idArticulo+")");
          ...
          var col4f3 = document.createElement("div");
              ...
              col4f3.setAttribute("id","valoracion"+elementos[i].idArticulo);
      ...
      var xmlbutton = document.getElementById("descargaXML");
      xmlbutton.style.display = "block";
  } else{
      var hijo = document.createElement("div");
          hijo.setAttribute("class", "alert alert-danger");
          hijo.setAttribute("role", "alert");
          hijo.innerHTML = "No se encontraron temas para mostrar";
      articulos.appendChild(hijo);
      contenedor.appendChild(articulos);

      var xmlbutton = document.getElementById("descargaXML");
      xmlbutton.style.display = "none";
  }
}
...
function like(id){
  ...
  xmlhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
        ...
        var boton = document.getElementById("botonlike"+id);
            boton.setAttribute("disabled","true");
            boton.innerHTML="<i class='far fa-thumbs-up'></i> "+respuesta.nlike;

        var puntuacion = document.getElementById("valoracion"+id);
            puntuacion.innerHTML="Valoracion: <b>"+respuesta.calificacion+"</b>";
    }
  };
  xmlhttp.open("GET", "like.php?idarticulo="+id, true);
  xmlhttp.send();
}

//Funcion para dislikes
function dislike(id){
  var xmlhttp = new XMLHttpRequest();
  xmlhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
        ...
        var boton = document.getElementById("botondislike"+id);
            boton.setAttribute("disabled","true");
            boton.innerHTML="<i class='far fa-thumbs-down'></i> "+respuesta.dislike;

        var puntuacion = document.getElementById("valoracion"+id);
            puntuacion.innerHTML="Valoracion: <b>"+respuesta.calificacion+"</b>";
    }
  };
  xmlhttp.open("GET", "dislike.php?idarticulo="+id, true);
  xmlhttp.send();
}

//Funcion para notinterested
function notinterested(id){
  ...
  xmlhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
        ...
        var boton = document.getElementById("botonnotinterested"+id);
            boton.setAttribute("disabled","true");
            boton.innerHTML="<i class='far fa-meh'></i> "+respuesta.interested;

        var puntuacion = document.getElementById("valoracion"+id);
            puntuacion.innerHTML="Valoracion: <b>"+respuesta.calificacion+"</b>";
    }
  };
  xmlhttp.open("GET", "notinterested.php?idarticulo="+id, true);
  xmlhttp.send();
}
...
function downloadXML(){
    ...
    xmlhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            location.href ="/php/Proyecto/articulos.xml";
        }
    };
    xmlhttp.open("GET", "generaXML.php?idTema="+idTema, true);
    xmlhttp.send();
}


/////////////////////////////////////////////////////////////
//Funcionamiento seccion alta articulo
